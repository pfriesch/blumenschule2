...
/**
 * BSApp\Entity\Product
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="BSApp\Entity\ProductRepository")
 */
class Product
{
    /**
...
//    /**
//     * TODO missing?
//     * @ORM\OneToMany(targetEntity="Product", mappedBy="inventory")
//     */
//    protected $inventories;
     ...
     * Set stock
     *
     * @param BSApp\Entity\Stock $stock
     */
     ...
     * Add ProductBundles
     *
     * @param BSApp\Entity\ProductBundle $productBundles
     */
    public function addProductBundle(ProductBundle $productBundles)
    {
    ...
    /**
     * Remove ProductBundles
     *
     * @param ProductBundle $productBundles
     */
    public function removeProductBundle(ProductBundle $productBundles)
    {
        $this->ProductBundles->removeElement($productBundles);
    }

    /**
     * Add inventories
     *
     * @param Product $inventories
     * @return Product
     */
    public function addInventory(Product $inventories)
    {
     ...
     * @param Product $inventories
     */
    public function removeInventory(Product $inventories)
    {
