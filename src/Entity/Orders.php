...
class Orders
{
    ...
    {
        $this->OrdersInfos = new ArrayCollection();
    }

    /**
     * Add OrdersInfos
     *
     * @param BSApp\Entity\OrdersInfo $ordersInfos
     */
    public function addOrdersInfo(OrdersInfo $ordersInfos)
    {
     ...
     * Set PaymentMethods
     *
     * @param BSApp\Entity\PaymentMethods $paymentMethods
     */
    public function setPaymentMethods(PaymentMethods $paymentMethods)
    {
     ...
     * Get PaymentMethods
     *
     * @return BSApp\Entity\PaymentMethods
     */
