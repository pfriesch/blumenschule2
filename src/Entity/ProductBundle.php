...
/**
 * BSApp\Entity\ProductBundle
 *
 * @ORM\Table(name="ProductBundle")
 * @ORM\Entity(repositoryClass="BSApp\Entity\ProductBundleRepository")
 */
class ProductBundle
{
    /**
     ...
     * Set Product
     *
     * @param BSApp\Entity\Product $product
     */
