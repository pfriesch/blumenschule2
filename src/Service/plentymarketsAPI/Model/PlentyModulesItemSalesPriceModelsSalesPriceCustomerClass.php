<?php
/**
 * PlentyModulesItemSalesPriceModelsSalesPriceCustomerClass
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesItemSalesPriceModelsSalesPriceCustomerClass Class Doc Comment
 *
 * @category Class
 * @package  BSApp\Service\plentymarketsAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesItemSalesPriceModelsSalesPriceCustomerClass implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'Plenty\Modules\Item\SalesPrice\Models\SalesPriceCustomerClass';
     ...
     * Sets created_at
     *
     * @param string $created_at The time the customer class was activated.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at The time the relationship between customer class and sales price was last updated.
     *
     * @return $this
     */
