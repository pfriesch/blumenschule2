<?php
/**
 * PlentyModulesListingMarketModelsListingMarket
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesListingMarketModelsListingMarket Class Doc Comment
 *
 * @category Class
 * @package  BSApp\Service\plentymarketsAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesListingMarketModelsListingMarket implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Plenty\Modules\Listing\Market\Models\ListingMarket';
...
'updated_at' => 'getUpdatedAt'    ];
     ...
     * Sets id
     *
     * @param int $id The ID of the listing market.
     *
     * @return $this
     */
     ...
     * Sets listing_id
     *
     * @param int $listing_id The listing ID of the current listing market.
     *
     * @return $this
     */
     ...
     * Sets variation_id
     *
     * @param int $variation_id The variation ID for this listing market.
     *
     * @return $this
     */
     ...
     * Sets referrer_id
     *
     * @param int $referrer_id The ID of the referrer.
     *
     * @return $this
     */
     ...
     * Sets credentials_id
     *
     * @param int $credentials_id The credentials ID that this listing market belongs to.
     *
     * @return $this
     */
     ...
     * Sets directory_id
     *
     * @param int $directory_id The directory ID of the listing market.
     *
     * @return $this
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled Indicates if the listing market is enabled.
     *
     * @return $this
     */
     ...
     * Sets duration
     *
     * @param string $duration The duration of the listing market.
     *
     * @return $this
     */
     ...
     * Sets verified
     *
     * @param string $verified Indicates if the listing market has been verified. Possible values are: 'succeeded', 'failed', 'unknown'.
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int $quantity The quantity set for this listing market.
     *
     * @return $this
     */
     ...
     * Sets all_variations
     *
     * @param bool $all_variations Indicates if all variations should be included.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at The date that the listing was created.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at The date that the listing was last updated.
     *
     * @return $this
     */
