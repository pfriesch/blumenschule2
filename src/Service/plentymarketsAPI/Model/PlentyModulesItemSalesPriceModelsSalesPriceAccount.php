<?php
/**
 * PlentyModulesItemSalesPriceModelsSalesPriceAccount
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesItemSalesPriceModelsSalesPriceAccount Class Doc Comment
 *
 * @category Class
 * @package  BSApp\Service\plentymarketsAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesItemSalesPriceModelsSalesPriceAccount implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'Plenty\Modules\Item\SalesPrice\Models\SalesPriceAccount';
     ...
     * Sets created_at
     *
     * @param string $created_at The time the referrer account was linked to the sales price.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at The time the link was last updated.
     *
     * @return $this
     */
