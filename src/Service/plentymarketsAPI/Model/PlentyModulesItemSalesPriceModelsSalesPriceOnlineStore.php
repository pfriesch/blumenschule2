<?php
/**
 * PlentyModulesItemSalesPriceModelsSalesPriceOnlineStore
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesItemSalesPriceModelsSalesPriceOnlineStore Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesItemSalesPriceModelsSalesPriceOnlineStore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Plenty\Modules\Item\SalesPrice\Models\SalesPriceOnlineStore';
...
'updated_at' => 'getUpdatedAt'    ];
     ...
     * Sets created_at
     *
     * @param string $created_at The time the client (store) was activated.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at The time the relationship between the client (store) and the sales price was last updated.
     *
     * @return $this
     */
