<?php
/**
 * PlentyModulesItemVariationAdditionalSkuModelsVariationAdditionalSku
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesItemVariationAdditionalSkuModelsVariationAdditionalSku Class Doc Comment
 *
 * @category Class
 * @package  BSApp\Service\plentymarketsAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesItemVariationAdditionalSkuModelsVariationAdditionalSku implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'Plenty\Modules\Item\VariationAdditionalSku\Models\VariationAdditionalSku';
     ...
     * Sets id
     *
     * @param int $id The ID of the additional sku
     *
     * @return $this
     */
     ...
     * Sets market_id
     *
     * @param BigDecimal $market_id The ID of the market reference.
     *
     * @return $this
     */
