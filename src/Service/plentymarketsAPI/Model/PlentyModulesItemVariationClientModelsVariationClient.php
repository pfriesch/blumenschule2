<?php
/**
 * PlentyModulesItemVariationClientModelsVariationClient
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesItemVariationClientModelsVariationClient Class Doc Comment
 *
 * @category Class
 * @package  BSApp\Service\plentymarketsAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesItemVariationClientModelsVariationClient implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'Plenty\Modules\Item\VariationClient\Models\VariationClient';
     ...
     * Sets created_at
     *
     * @param string $created_at The time at which the client (store) was linked to the variation.
     *
     * @return $this
     */
