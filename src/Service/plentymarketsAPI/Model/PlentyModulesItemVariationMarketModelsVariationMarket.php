<?php
/**
 * PlentyModulesItemVariationMarketModelsVariationMarket
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PlentyModulesItemVariationMarketModelsVariationMarket Class Doc Comment
 *
 * @category Class
 * @package  BSApp\Service\plentymarketsAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlentyModulesItemVariationMarketModelsVariationMarket implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Plenty\Modules\Item\VariationMarket\Models\VariationMarket';
...
'created_at' => 'getCreatedAt'    ];
     ...
     * Sets market_id
     *
     * @param int $market_id The unique ID of the market
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at The time the link between the variation and the market was created.
     *
     * @return $this
     */
