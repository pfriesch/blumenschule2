...
class BatchApi
{
     ...
     */
    public function restBatchGet($body = null)
    {
        list($response) = $this->restBatchGetWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response
     */
    public function restBatchGetWithHttpInfo($body = null)
    {
        $returnType = '\BSApp\Service\plentymarketsAPI\Model\Mixed[]';
        $request = $this->restBatchGetRequest($body);
     ...
     * @throws InvalidArgumentException
     */
    public function restBatchGetAsync($body = null)
    {
        return $this->restBatchGetAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws InvalidArgumentException
     */
    public function restBatchGetAsyncWithHttpInfo($body = null)
    {
        $returnType = '\BSApp\Service\plentymarketsAPI\Model\Mixed[]';
        $request = $this->restBatchGetRequest($body);
     ...
     * @throws InvalidArgumentException
     */
    protected function restBatchGetRequest($body = null)
    {
