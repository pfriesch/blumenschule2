...
use BSApp\Service\plentymarketsAPI\Model\PlentyModulesAccountContactModelsContact;
...
class ConvertGuestsApi
{
     ...
     *
     *
     * @return PlentyModulesAccountContactModelsContact
     * @throws InvalidArgumentException
     * @throws ApiException on non-2xx response
     */
    public function restAccountsGuestsConvertPost()
    {
        list($response) = $this->restAccountsGuestsConvertPostWithHttpInfo();
        return $response;
    }
    ...
    {
        return $this->restAccountsGuestsConvertPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws InvalidArgumentException
     */
    protected function restAccountsGuestsConvertPostRequest()
    {
