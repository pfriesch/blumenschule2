...
class Product
{
    ...
    */
     ...
     * @param \Acme\BSDataBundle\Entity\ProductBundle $productBundles
     */
    public function removeProductBundle(\Acme\BSDataBundle\Entity\ProductBundle $productBundles)
    {
     ...
     * Add inventories
     *
     * @param \Acme\BSDataBundle\Entity\Product $inventories
     * @return Product
     */
    public function addInventory(\Acme\BSDataBundle\Entity\Product $inventories)
    {
     ...
     * @param \Acme\BSDataBundle\Entity\Product $inventories
     */
    public function removeInventory(\Acme\BSDataBundle\Entity\Product $inventories)
    {
