...
var buildtable = function buildTable(data) {
    ...
    $.each(data, function (key, val) {
        ...
        if (existitem.length > 0) {
            ...
            $('.itemEdit a[data-id=' + val['id'] + ']').click(function () {
...
// Bezahl Dialog
    ...
    $('.input_buttons div').click(function () {
        ...
        if (quantity.length > 0) {
            ...
            addQuery('/cashbox/' + id + '/checkout/' + checkout + '/add', {
                name: $(this).html(),
                code: code,
                quantity: quantity
            });
    ...
    $(document).keyup(function (event) {
        ...
        if (event.keyCode > 112 && event.keyCode < 122) {
            ...
            addQuery('/cashbox/' + id + '/checkout/' + id_checkout + '/add', {
                name: item.html(),
                code: code,
                quantity: quantity
            });
    ...
    $('#inputkeyboard').keyup(function (event) {
        console.log(event.keyCode);
